...
namespace Semana02
{
    public partial class FrmPedidosDetalle : Form
    {
        ...
        public void CboAnios_SelectionChangeCommitted(object sender, EventArgs e)
        {
           
        }

        public void DgPedidos_DoubleClick(object sender, EventArgs e)
        {
        ...
        private void DgPedidos_DoubleClick_1(object sender, EventArgs e)
        {
            int Codigo;
